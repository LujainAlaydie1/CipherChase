    ...
    var body: some View {
        ZStack{
            ...
            GeometryReader { geometry in
                ...
                VStack(spacing: -20) {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("trophey")
                            ...
                            .offset(x: CGFloat(progress) * 390) // Adjust the offset based on the progress
                    }
                }
                ...
                Circle()
                    .foregroundColor(Color(red: 0.88, green: 0.93, blue: 0.93))
