...
struct endScenario: View {
    ...
    Fingers dance over keyboards, decoding the binary puzzle. As the final letter falls into place, the room trembles. The holographic projection of The Encoder reacts, sinister laughter replaced by an unsettling silence.
    Success opens a virtual doorway, transporting the team to the final confrontation in the heart of the virtual realm. Towering lines of code surround them, forming The Encoder's master code. The challenge is set: decipher this code, unveil The Encoder's identity, and save the coding academy.
"""
